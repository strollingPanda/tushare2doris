...
def create_table():
    ...
    operation = (
        ...
        + "."
        + config["Ts_HuShenGuPiao_HangQingShuJu_RiXianHangQing"]["table_name"]
        + """
        (
        ...
        COMMENT "tushare_沪深股票_行情数据_日线行情"
...
def download():
    ...
    # 下载数据存储的表格名称
    table_name = config["Ts_HuShenGuPiao_HangQingShuJu_RiXianHangQing"]["table_name"]
